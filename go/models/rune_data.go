...
// RuneNames maps characteristic names to their corresponding rune code names
var RuneNames = map[string][]string{
...
// RuneNumbers maps characteristic names to their corresponding rune IDs
var RuneNumbers = map[string][]int{
	"Vitality":             {1, 2, 3},
	"Strength":             {4, 5, 6},
	"Chance":               {7, 8, 9},
...
// CaracID maps characteristic names to their unique IDs
var CaracID = map[string]int{
	"Vitality":             1,
	"Strength":             2,
	"Chance":               3,
	"Intelligence":         4,
...
// RuneIDs maps caracId keys to runeNumbers values
var RuneIDs = map[int][]int{
	1:  {1, 2, 3},     // Vitality
	2:  {4, 5, 6},     // Strength
	3:  {7, 8, 9},     // Chance
...
// RuneWeight maps rune IDs to their weights
var RuneWeight = map[int]float64{
	1:  1.0,    // vi (Vitality)
...
// CaracValue represents a characteristic value and its ID
type CaracValue struct {
	Value int
	ID    int
}
